...
const WeChatForm: React.FC<AlertInstanceFormProps> = (props) => {
  ...
  const renderContent = (vals) => {
    form.setFieldsValue({"msgtype": 'text'})
    return (
      <>
        <Divider>{l('pages.rc.alert.instance.feige')}</Divider>
        <Form.Item
          name="name"
        ...
        <Form.Item
          ...
          rules={[{message: l('pages.rc.alert.instance.webhookPleaseHolder')}]}
        >
        ...
        <Form.Item
          name="chatid"
          label={l('pages.rc.alert.instance.chatid')}
          rules={[{required: true, message: l('pages.rc.alert.instance.chatidPleaseHolder')}]}
        >
          <Input placeholder={l('pages.rc.alert.instance.chatidPleaseHolder')}/>
        </Form.Item>
        <Form.Item
          name="appkey"
          label={l('pages.rc.alert.instance.appkey')}
        >
          <Input type="password" placeholder={l('pages.rc.alert.instance.appkeyPleaseHolder')}/>
        </Form.Item>
        <Form.Item
          name="apisecret"
          label={l('pages.rc.alert.instance.apisecret')}
        >
          <Input type="password" placeholder={l('pages.rc.alert.instance.apisecretPleaseHolder')}/>
        </Form.Item>
        <Form.Item
          name="keyword"
          label={l('pages.rc.alert.instance.keyword')}
          rules={[{required: true, message: l('pages.rc.alert.instance.keywordPleaseHolder')}]}
        >
        ...
        >
          <Radio.Group defaultValue={'text'} >
            ...
            <Radio value='text' autoFocus={true}>{l('pages.rc.alert.instance.text')}</Radio>
          </Radio.Group>
        </Form.Item>
        <Form.Item
          name="enabled"
